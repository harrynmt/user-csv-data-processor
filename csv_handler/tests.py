...
class CSVUploadTests(APITestCase):
    ...
    def test_upload_valid_csv(self):
        ...
        csv_file = SimpleUploadedFile(
            "valid_users.csv", csv_data.encode("utf-8"), content_type="text/csv"
        )
    ...
    def test_upload_invalid_csv(self):
        ...
        csv_data = """name,email,age
                      ...
                      John Doe,john@example.com,30"""
        csv_file = SimpleUploadedFile(
            "invalid_users.csv", csv_data.encode("utf-8"), content_type="text/csv"
        )
...
,test@example.com,20"""
        ...
        self.assertIn(
            "Name must be a non-empty string", str(response.data["rejected_records"])
        )
...
test,test@example.com,200"""
        ...
        self.assertIn(
            ...
            str(response.data["rejected_records"]),
        )
